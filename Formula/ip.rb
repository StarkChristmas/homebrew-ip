class Ip < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/StarkChristmas/ipget/releases/download/v1.0.0/ip_macos_1.0.0_arm64.tar.gz"
    sha256 "c6093016dec0cb27576dcaa486fbe47140640646198ac57757392280635122c6"
  else
    url "https://github.com/StarkChristmas/ipget/releases/download/v1.0.0/ip_macos_1.0.0_x86_64.tar.gz"
